...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.jish-cli.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".jish-cli" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".jish-cli")
	}
